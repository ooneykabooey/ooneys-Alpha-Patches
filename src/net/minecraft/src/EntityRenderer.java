...
public class EntityRenderer {
	...
	public float getFOVModifier(float var1) {
		...
		float var3 = this.mc.options.fovOption;
    ...
    private void orientCamera(float var1) {
        ...
        if (this.mc.options.thirdPersonView) {
            double var9 = 4.0D; // Camera distance
            ...
            double var13 = -MathHelper.sin(var11 / 180.0F * (float)Math.PI) * MathHelper.cos(var12 / 180.0F * (float)Math.PI) * var9;
            double var15 = MathHelper.cos(var11 / 180.0F * (float)Math.PI) * MathHelper.cos(var12 / 180.0F * (float)Math.PI) * var9;
            double var17 = -MathHelper.sin(var12 / 180.0F * (float)Math.PI) * var9;

            // Raytrace for collisions
            for (int var19 = 0; var19 < 8; ++var19) {
                float var20 = ((var19 & 1) * 2 - 1) * 0.1F;
                float var21 = (((var19 >> 1) & 1) * 2 - 1) * 0.1F;
                float var22 = (((var19 >> 2) & 1) * 2 - 1) * 0.1F;
                ...
                if (var23 != null) {
                    ...
                    if (var24 < Math.abs(var9)) {
                        var9 = var9 < 0 ? -var24 : var24;
                        var13 = -MathHelper.sin(var11 / 180.0F * (float)Math.PI) * MathHelper.cos(var12 / 180.0F * (float)Math.PI) * var9;
                        var15 = MathHelper.cos(var11 / 180.0F * (float)Math.PI) * MathHelper.cos(var12 / 180.0F * (float)Math.PI) * var9;
                        var17 = -MathHelper.sin(var12 / 180.0F * (float)Math.PI) * var9;
                    }
                }
            }

            // Rotate camera correctly depending on front/back
            if (front) {
                GL11.glRotatef(var2.rotationPitch - var12, 1.0F, 0.0F, 0.0F);
                GL11.glRotatef(var2.rotationYaw - var11 + 180.0F, 0.0F, 1.0F, 0.0F);
            ...
            // Undo rotation for proper orientation
	...
	private void renderHand(float var1, int var2) {
        ...
        if (!this.mc.hideUI && !this.mc.options.thirdPersonView) {
	...
	private void renderSnow(float var1) {
        ...
        int var41 = MathHelper.floor_double(var10);
		byte var14 = 5;
		if(this.mc.options.fancyGraphics) {
			var14 = 10;
		}
		...
		for(int var15 = var4 - var14; var15 <= var4 + var14; ++var15) {
			for(int var16 = var6 - var14; var16 <= var6 + var14; ++var16) {
				...
				if(var18 != var19) {
					...
					float var30 = var3.getBrightness(var15, var40, var16);
